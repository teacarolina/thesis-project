        ...
        <Navbar/>
            <main className="relative container mx-auto bg-white px-4">
                <article className="max-w-prose mx-auto py-8">
                    <h1 className="text-2xl font-bold">Brand Privacy Policy</h1>
                    <h2 className="mt-2 text-sm text-gray-500">This page describes our policies and practices regarding the collection and use of your personal data as well as sets forth your privacy rights.</h2>
