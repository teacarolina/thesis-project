    ...
    return (
        ...
        <Navbar/>
            <Header 
                ...
                text3="This page describes our policies and practices as well as use of your personal data and sets forth your privacy rights."/>
            <main className="relative container mx-auto bg-white px-4">
                <article className="max-w-prose mx-auto py-8">
                    ...
                    <h2 className="mt-2 text-sm text-black font-bold">Customer commitment to data protection and privacy</h2>
                    ...
                    <h2 className="mt-2 text-sm text-black font-bold">Principles</h2>
                    ...
                    <h2 className="mt-2 text-sm text-black font-bold">Why do we process your data?</h2>
                    ...
                    <h2 className="mt-2 text-sm text-black font-bold">Who is responsible for processing of your personal data?</h2>
