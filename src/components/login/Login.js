    ...
    return (
        ...
        <div class="h-screen md:flex">
          ...
          <div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
              <form class="bg-white">
                  <h1 class="text-gray-800 font-bold text-2xl mb-1">Hi friend!</h1>
                  ...
                  <button type="submit" 
                      ...
                      <span class="text-sm ml-2 hover:text-blue-500 cursor-pointer"><Link to="/register">No account yet ?</Link></span>
              </form>
          </div>
      </div>  
      </>
